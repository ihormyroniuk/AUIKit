Pod::Spec.new do |s|
  ...
  s.description  = "AUIKit is an advanced extension for UIKit framework. It contains principles, best practices and code solutions for building efficient, reliable and maintable user interface."
