...
open class PresentAnimationTransitioningDelegate: NSObject, UIViewControllerTransitioningDelegate, PresentAnimatedTransitioningDelegate, DismissAnimatedTransitioningDelegate {
