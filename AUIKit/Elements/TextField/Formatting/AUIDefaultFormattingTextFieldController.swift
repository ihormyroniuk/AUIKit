//
//  AUIDefaultFormattingTextFieldController.swift
//  AUIKit
//
...
open class AUIDefaultFormattingTextFieldController: AUIDefaultTextFieldController, AUIFormattingTextFieldController {
  ...
  open override func textField(shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
    guard let inputtedTextFormatter = inputtedTextFormatter else { return true }
